...
static wchar_t *g_PropNames[] = {L"IsPause"};
static wchar_t *g_MethodNames[] = {L"PlayFile",L"StopPlay"};

static wchar_t *g_PropNamesRu[] = {L"Ётоѕауза"};
static wchar_t *g_MethodNamesRu[] = {L"»грать‘айл",L"—топ»грать"};
...
{ 
MessageBox(0, L"„лен", L"„лен", MB_OK);

	//if (!BASS_Init(-1,44100,0,0,NULL)) MessageBox(0, L"Can't initialize device", L"Error", MB_OK);
